...
let lastPred = '';
const CONSEC_REQUIRED = 3; // Less than CLI because we sample less often
...
document.addEventListener('keydown', e => {
    // If camera is running and user types a letter, add it as detected
    if (!state.isRunning) return;
...
// ========== INIT ==========
console.log('Sign Language Converter - Frontend Loaded');
